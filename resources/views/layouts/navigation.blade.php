        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <img src="/storage/uranus.png" class="block h-9 w-auto fill-current text-gray-800" alt="">
                        {{-- <x-application-logo  /> --}}
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(Auth::user()->usertype == 'user')
                        ...
                        <x-nav-link :href="route('folder')" :active="request()->routeIs('folder')">
                            Yêu thích
                        </x-nav-link>
                    ...
                    @if(Auth::user()->usertype == 'admin')
                        ...
                        <x-nav-link :href="route('admin.words.index')" :active="request()->routeIs('admin.words.index')">
                            Word
                        </x-nav-link>
                      @endif
